...
public class SegmentVisualizer extends JPanel {
    private static final long serialVersionUID = 1L;

    private final BufferedImage image;

    public SegmentVisualizer(final String name) {
        ...
        pathFormer.formPaths(reader.getTriangulation());

        draw(pathFormer.getPoints(), pathFormer.getPaths());
    }
