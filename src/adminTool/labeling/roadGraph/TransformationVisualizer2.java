...
public class TransformationVisualizer2 extends JFrame {
    private static final long serialVersionUID = 1L;

    public TransformationVisualizer2() {
        ...
        public ImagePanel() {
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                for (int j = 0; j < 2; ++j) {
                    ...
                    iterator.next();
                    g2.setColor(Color.BLACK);
                    Point2D point = lineIntersectsLine(coords1[0], coords1[1], coords2[0], coords2[1],
            ...
            Point2D intersection = lineIntersectsLine(x1, y1, x2, y2, x3, y3, x4, y4);
