...
public class WayExpansionCreator extends AbstractMapCreator {
    ...
    public void create() {
        ...
        // TOOO
        // Map<Integer, Collection<Integer>> streetExpansions =
        // createExpansions(streets);
        // Map<Integer, Collection<Integer>> wayExpansions =
        // createExpansions(ways);
    }

    // private Map<Integer, Collection<Integer>> createExpansions(final Way[]
    // ways) {
    // HashMap<Node, Collection<Integer>> nodeMap = new HashMap<Node,
    // Collection<Integer>>();
    //
    ...
    // }
    //
    // Map<Integer, Collection<Integer>> wayExpansions = new
    // HashMap<Integer, Collection<Integer>>();
    //
    ...
    // private void fillExpansions(final Map<Integer, Collection<Integer>>
    // wayExpansions,
