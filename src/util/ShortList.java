...
public class ShortList {
    ...
    public ShortList(final short[] data) {
        this.data = data;
    ...
    public ShortList(final ShortList list) {
        this.data = new short[list.data.length];
        System.arraycopy(list.data, 0, data, 0, data.length);
        this.size = list.size;
    }

    // list[from,to)
    public ShortList(final ShortList list, final int from, final int to) {
        if (to < from)
    ...
    public int set(final int index, final short element) {
        rangeCheck(index);
    ...
    public boolean addAll(final ShortList list) {
        short[] a = list.data;
