...
public class OSMColorScheme extends ColorScheme {
    ...
    private static WayStyle[] createWayStyles() {
        ...
        wayStyles[2] = new WayStyle(wayMinZoomstep[2], new float[] { 1.1225f, 1.25f, 2f, 3f, 6f, 6f, 11f, 11f, 16f },
                new float[] { 1.1225f, 1.25f, 2f, 3f, 7f, 7f, 12f, 12f, 17f }, new Color(248, 213, 168),
                new Color(208, 167, 114));

        // tertiary (yellow)
        wayMinZoomstep[3] = 12;
        wayStyles[3] = new WayStyle(wayMinZoomstep[3], new float[] { 2f, 6f, 6f, 11f, 11f, 16f },
                new float[] { 2f, 7f, 7f, 12f, 12f, 17f }, new Color(248, 248, 186), new Color(200, 200, 200));

        // road (gray + darker gray outline)
        wayMinZoomstep[4] = 13;
        wayStyles[4] = new WayStyle(wayMinZoomstep[4], new float[] { 1.5f, 3f, 6f, 9f, 12f, 13f, 14f },
                new float[] { 2.5f, 4f, 7f, 10f, 13f, 14f, 15f }, new Color(200, 200, 200), new Color(170, 170, 170));
        ...
        wayStyles[5] = new WayStyle(wayMinZoomstep[5], new float[] { 2f, 4f, 6f, 8f, 10f }, new float[] { 0, 0, 0, 0 },
                ...
                BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, new float[] { 2f, 3f, 6f, 9f, 12f },
                new float[] { 3f, 4.5f, 8f, 12f, 16f });
        ...
        wayStyles[14] = new WayStyle(wayMinZoomstep[14],
                ...
                new float[] { 0.5f, 1f, 1.1225f, 1.25f, 2f, 3.5f, 7f, 7f, 12f, 12f, 17f }, new Color(248, 178, 156),
                new Color(240, 92, 43));
    ...
    private static int[][] createWayOrder() {
        return new int[][] { { 10 }, { 11 }, { 19 }, { 17 }, { 18 }, { 12 }, { 22 }, { 23 }, { 0, 1 }, { 3 }, { 2 },
                { 4 }, { 16 }, { 14 }, { 13 }, { 15 }, { 5 }, { 6 }, { 7 }, { 8 }, { 9 }, { 20 }, { 21 }, { 25 },
                { 24 } };
    }
    ...
    private static ShapeStyle[] createAreaStyles() {
        ...
        areaStyles[5] = new ShapeStyle(areaMinZoomstep[5], new float[] { 0 }, new float[] { 0, 0, 0, 0, 0, 0, 1 },
        ...
        areaStyles[9] = new ShapeStyle(areaMinZoomstep[9], new float[] { 0 }, new float[] { 0, 0, 0, 0, 1 },
        ...
        areaStyles[14] = new ShapeStyle(areaMinZoomstep[14], new float[] { 0 }, new float[] { 0, 0, 0, 1 },
                new Color(170, 202, 174), new Color(134, 149, 135));
        ...
        areaStyles[16] = new ShapeStyle(areaMinZoomstep[16], new float[] { 0 }, new float[] { 0, 0, 0, 0, 0, 1 },
        ...
        areaStyles[23] = new ShapeStyle(areaMinZoomstep[23], new float[] { 0 }, new float[] { 0, 0, 1 },
