...
public class AbstractParallelImageFetcher extends AbstractImageFetcher implements IImageFetcher {

    private RenderPool threadPool;
    private IRenderer[] renderers;

    public AbstractParallelImageFetcher(final IMapManager manager, final IFactory<IRenderer> factory) {
        super(manager);
