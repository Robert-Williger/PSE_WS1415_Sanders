...
public class WayStyle extends ShapeStyle {
    ...
    public WayStyle(final int minZoomStep, final float[] mainWidth, final float[] outlineWidth,
            final float[] middleLineWidth, final Color mainColor, final Color outlineColor,
            final Color middleLineColor, final int cap, final int join, final float[] dash, final float[] dashSpacing) {
    ...
    public WayStyle(final int minZoomStep, final float[] mainWidth, final float[] outlineWidth,
            final float[] middleLineWidth, final Color mainColor, final Color outlineColor,
            final Color middleLineColor, final int cap, final int join, final float[] dash) {
        this(minZoomStep, mainWidth, outlineWidth, middleLineWidth, mainColor, outlineColor, middleLineColor, cap,
                join, dash, new float[]{0});
    }
    ...
    public WayStyle(final int minZoomStep, final float[] mainWidth, final Color mainColor, final int cap, final int join) {
