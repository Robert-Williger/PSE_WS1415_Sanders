...
public class BlossomAlgorithmTest {
    ...
    public void computerGeneratedTest3() {
        final int nodes = 8;
        final int[] weights = new int[]{33, 65, 76, 59, 56, 52, 17, 59, 71, 96, 98, 53, 3, 4, 49, 8, 12, 99, 72, 29, 2,
                43, 44, 50, 88, 24, 69, 15};
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);
    ...
    public void computerGeneratedTest8() {
        final int nodes = 8;
        final int[] weights = new int[]{7, 91, 5, 5, 90, 35, 39, 26, 0, 71, 47, 46, 75, 44, 46, 63, 42, 80, 42, 77, 53,
                68, 19, 26, 20, 22, 96, 61};
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);
    ...
    private long[] createEdges(final int nodes) {
