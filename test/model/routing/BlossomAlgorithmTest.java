...
public class BlossomAlgorithmTest {
    ...
    public void testVerySmallAugmention() {
        final int nodes = 6;
        final int[] weights = new int[] { 62, 22, 2, 80, 36, 6, 30, 64, 50, 28, 40, 72, 46, 48, 20 };
        ...
        checkMatching(matching, undirectedGraph, 28);
    }

    @Test
    public void testVerySmallGrow1() {
        final int nodes = 6;
        final int[] weights = new int[] { 42, 4, 6, 14, 8, 34, 58, 68, 64, 68, 36, 26, 62, 50, 6 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 46);
    }

    @Test
    public void testVerySmallGrow2() {
        final int nodes = 6;
        final int[] weights = new int[] { 40, 52, 50, 46, 70, 36, 46, 34, 54, 28, 64, 20, 6, 28, 34 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 66);
    }

    @Test
    public void testVerySmallShrink1() {
        final int nodes = 6;
        final int[] weights = new int[] { 30, 38, 36, 2, 58, 4, 28, 28, 80, 68, 40, 14, 18, 70, 36 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 44);
    }

    @Test
    public void testVerySmallShrink2() {
        final int nodes = 6;
        final int[] weights = new int[] { 80, 66, 22, 42, 44, 30, 52, 38, 38, 74, 62, 50, 36, 48, 72 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 110);
    }

    @Test
    public void testVerySmallShrink3() {
        final int nodes = 6;
        final int[] weights = new int[] { 50, 42, 22, 2, 72, 14, 56, 80, 38, 50, 58, 50, 8, 54, 64 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 70);
    }

    @Test
    public void testSmallShrink() {
        final int nodes = 8;
        final int[] weights = new int[] { 42, 4, 6, 14, 8, 45, 58, 68, 64, 58, 36, 26, 62, 50, 6, 52, 24, 44, 30, 26, 4,
                32, 60, 40, 2, 60, 42, 44 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);
    ...
    public void testSmallShrinkAndExpand() {
        final int nodes = 8;
        final int[] weights = new int[] { 40, 52, 50, 46, 70, 36, 46, 34, 54, 28, 64, 20, 6, 28, 34, 24, 2, 30, 42, 18,
                36, 8, 14, 80, 22, 22, 64, 80 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 64);
    }
    ...
    public void testNormalShrink() {
        ...
        final int[] weights = new int[] { 62, 22, 2, 80, 36, 6, 30, 64, 50, 28, 40, 72, 46, 48, 20, 28, 18, 64, 48, 48,
                ...
                56, 2, 72, 24, 28, 60, 70, 32, 66, 74, 30, 38, 14, 36, 54, 66, 12, 72, 78 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 48);
    }
    ...
    public void testGreatShrink1() {
        ...
        checkMatching(matching, undirectedGraph, 74);
    }
    ...
    public void testGreatShrink2() {
        ...
        checkMatching(matching, undirectedGraph, 120);
    }
    ...
    public void testGreatShrinking3() {
        ...
        checkMatching(matching, undirectedGraph, 76);
    }

    @Test
    public void testGreatGraph() {
        final int nodes = 16;
        final int[] weights = new int[] { 76, 2, 30, 43, 20, 28, 3, 75, 60, 77, 58, 29, 16, 32, 52, 98, 63, 21, 19, 18,
                69, 32, 96, 70, 72, 6, 32, 6, 68, 98, 61, 81, 33, 48, 41, 48, 97, 33, 68, 82, 24, 78, 26, 90, 15, 63,
                73, 44, 80, 76, 86, 68, 74, 86, 88, 24, 78, 27, 90, 68, 65, 66, 85, 7, 39, 48, 6, 29, 85, 31, 28, 63,
                96, 7, 80, 30, 63, 8, 75, 21, 42, 37, 16, 6, 99, 1, 75, 71, 54, 89, 75, 73, 93, 99, 16, 40, 52, 16, 2,
                64, 72, 68, 22, 93, 56, 56, 38, 96, 46, 67, 99, 57, 25, 53, 89, 36, 42, 86, 74, 91 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        checkMatching(matching, undirectedGraph, 111);
    }

    @Test
    public void computerGeneratedTest1() {
        final int nodes = 6;
        final int[] weights = new int[] { 68, 63, 71, 85, 50, 37, 91, 83, 38, 53, 57, 9, 42, 16, 56 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        // matching [(3,4)(2,5)(0,1)]
        checkMatching(matching, undirectedGraph, 119);
    }

    @Test
    public void computerGeneratedTest2() {
        final int nodes = 6;
        final int[] weights = new int[] { 0, 10, 77, 46, 58, 25, 29, 64, 34, 91, 53, 29, 19, 49, 6 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        // matching [(4,5)(1,3)(0,2)]
        checkMatching(matching, undirectedGraph, 45);
    }

    @Test
    public void computerGeneratedTest3() {
        final int nodes = 8;
        final int[] weights = new int[] { 33, 65, 76, 59, 56, 52, 17, 59, 71, 96, 98, 53, 3, 4, 49, 8, 12, 99, 72, 29,
                2, 43, 44, 50, 88, 24, 69, 15 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        // matching [(3,6)(2,5)(1,7)(0,4)]
        checkMatching(matching, undirectedGraph, 72);
    }
    ...
    public void computerGeneratedTest4() {
        ...
        checkMatching(matching, undirectedGraph, 73);
    }

    @Test
    public void computerGeneratedTest5() {
        final int nodes = 6;
        final int[] weights = new int[] { 29, 45, 64, 26, 78, 59, 98, 70, 39, 55, 41, 80, 48, 84, 34 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);

        // matching [(4,5)(2,3)(0,1)]
        checkMatching(matching, undirectedGraph, 118);
    ...
    public void computerGeneratedTest6() {
        ...
        checkMatching(matching, undirectedGraph, 75);
    ...
    public void computerGeneratedTest8() {
        final int nodes = 8;
        final int[] weights = new int[] { 7, 91, 5, 5, 90, 35, 39, 26, 0, 71, 47, 46, 75, 44, 46, 63, 42, 80, 42, 77,
                53, 68, 19, 26, 20, 22, 96, 61 };
        final UndirectedGraph undirectedGraph = new UndirectedGraph(nodes, createEdges(nodes), weights);
        final Set<Long> matching = new BlossomAlgorithm().calculatePerfectMatching(undirectedGraph);
    ...
    public void computerGeneratedTest9() {
        ...
        checkMatching(matching, undirectedGraph, 86);
    }
    ...
    private void checkMatching(final Set<Long> matching, final IUndirectedGraph undirectedGraph,
        ...
        for (final long edge : matching) {
            ...
            final int firstNode = undirectedGraph.getFirstNode(edge);
            final int secondNode = undirectedGraph.getSecondNode(edge);

            assertTrue(firstNode >= 0 && firstNode < undirectedGraph.getNodes());
            assertTrue(secondNode >= 0 && secondNode < undirectedGraph.getNodes());
    ...
    private int[][] createEdges(final int nodes) {
        final int[][] edges = new int[2][nodes * (nodes - 1) / 2];
