...
public class ImageLoaderTest {
    ...
    public static void setUpClass() {
        ...
        buildings[0] = Building.create(new Node[]{new Node(362, 946), new Node(362, 1046), new Node(462, 1046),
                new Node(462, 946)}, new StreetNode(0.125f, streets[1]), "10");
        ...
        buildings[5] = Building.create(new Node[]{new Node(1118, 1474), new Node(1118, 1574), new Node(1218, 1574),
                new Node(1218, 1474)}, new StreetNode(0.4f, streets[2]), "22");
