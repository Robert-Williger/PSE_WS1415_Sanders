...
public class BackgroundRendererTest {
    ...
    public static void setUpClass() {
        ...
        iBuildings = new IBuilding[]{IBuilding.create(new int[]{2, 5, 10, 3}, new int[]{2, 5, 3, 0}, streetNode, "15")};
    ...
    public void testAreaRendering() {
        final Tile tile = new Tile(1, 1, 1, new IWay[0], new IStreet[0], iAreas, new IBuilding[0], new POI[0], new Label[0]);
    ...
    public void testWayRendering() {
        final Tile tile = new Tile(1, 1, 1, ways, new IStreet[0], new IArea[0], new IBuilding[0], new POI[0], new Label[0]);
        assertTrue(renderer.render(tile, renderImage));
        assertTrue(imageChanged());
    }
    ...
    public void testStreetRendering() {
        final Tile tile = new Tile(4, 1, 1, new IWay[0], iStreets, new IArea[0], new IBuilding[0], new POI[0], new Label[0]);
        assertTrue(renderer.render(tile, renderImage));
        assertTrue(imageChanged());
    }
    ...
    public void testBuildingRendering() {
        final Tile tile = new Tile(6, 1, 1, new IWay[0], new IStreet[0], new IArea[0], iBuildings, new POI[0], new Label[0]);
        assertTrue(renderer.render(tile, renderImage));
        assertTrue(imageChanged());
    }
